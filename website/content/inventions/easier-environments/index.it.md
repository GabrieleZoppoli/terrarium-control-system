...
Il contrasto con il terrario d'alta quota è proprio il punto: qui vivono le piante la cui fascia di preferenza cade già dentro un soggiorno genovese, se aggiungi *vapore acqueo* e lasci stare la temperatura. Meno ingegneria del terrario, più di un sottovaso bagnato sul davanzale.

## Chi c'è sui ripiani

Un cast a rotazione. Le piante che crescono troppo per la loro nicchia o che iniziano a chiedere notti più fresche migrano nel terrario d'alta quota; le nuove arrivate che non hanno bisogno delle temperature da foresta nebulosa partono da qui, e ci restano se stanno bene.

| Residente | Provenienza | Perché qui e non nel terrario |
|---|---|---|
...
| *Cephalotus follicularis* + f. 'Hummer's Giant' | Giardino Carnivoro · David Maccioni | Odia la minima notturna del terrario d'alta quota (13 °C) e l'aria ferma; preferisce un posto più asciutto, più luminoso e più ventilato. |
...
| *Angraecum didieri* | Growlist | Miniatura malgascia; intermediate-warm, non tollera la caduta notturna del terrario d'alta quota. |
| *Bulbophyllum makoyanum* | Regalo | Da quote basse-intermedie del Sud-est asiatico; il terrario è troppo fresco di notte per lui. |
...
Il setup completo costa una frazione del terrario d'alta quota. Anche il modello mentale è questo: *il terrario è dove si investe ingegneria full-stack quando la specie lo esige; i ripiani nebulizzati sono dove se ne investe quanto basta quando la specie lo permette.*

## Perché conta come "invenzione"

A rigore, non conta. È un promemoria: la soluzione che sembra impressionante è quasi sempre la scelta di default sbagliata. La maggior parte delle piante che finiscono nel terrario d'alta quota non ne hanno davvero bisogno. Questi ripiani documentano quelle che non lo richiedono.
