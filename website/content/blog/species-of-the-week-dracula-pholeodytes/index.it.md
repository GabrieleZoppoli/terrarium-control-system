...
*Dracula pholeodytes* è più piccola della *Raven 'Jet'* che le sta vicino, ma piccolo qui non significa sottotono. I tre sepali si prolungano in **caudae** (code) scure e sottili — le code che definiscono il genere — che trascinano l'intero fiore fino a circa 15 cm di altezza. Aprendo il vetro, la prima cosa che vedi è la coppa sepalina: un cappuccio a forma di cuore, viola-marrone picchiettato, aperto in avanti. Dentro la coppa siede un labello pallido a forma di piccolo teschio — la **"faccia di scimmia"** che ha reso *Dracula* un genere di culto. La *pholeodytes*, per i miei gusti, è una delle scimmie più belle del genere.
