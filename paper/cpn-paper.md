...
The full control system is open-source and described in a companion engineering paper (Zoppoli 2026a), with build photos, live conditions, blog posts, and the complete parts list on the project website (https://highlandcloudforest.com), enabling other growers and institutions to replicate or adapt the approach. A companion paper (Zoppoli 2026b) describes the orchid cultivation results from the same system.

---

## Acknowledgments

I thank the specialist nurseries that supplied legally and ethically sourced, artificially-propagated material for this collection — among them Andreas Wistuba (*Heliamphora*, highland *Nepenthes*) and Christian & Claudia Klein / Carnivors & More — and the highland carnivorous-plant growing community, whose shared cultivation experience informed the species selection and care regime described here. *[Author to add or amend: any individuals, family members credited in the collection records, institutional support, or reviewers the author wishes to thank.]*
...
Zoppoli, G. 2026a. Weather-Mimicking Terrarium for Cloud Forest Species: An Open-Source Climate Simulation System Using Real-Time Meteorological Data. *HardwareX* (submitted; companion engineering paper). DOI assigned on acceptance.

Zoppoli, G. 2026b. Cloud Forest in a Box: Growing Highland Orchids with Real-Time Weather Simulation. *Orchids* (American Orchid Society) (submitted; companion horticultural paper).

Zoppoli, G. 2026c. First bloom: *Utricularia quelchii*, three years in. Highland Cloud Forest project website (blog post, 20 April 2026, updated 7 and 11 May 2026). https://highlandcloudforest.com (accessed June 2026).

cexx.org. 2011. Peltier element efficiency. https://www.cexx.org/peltier.htm (accessed February 2026).

*Note on the companion citations (Zoppoli 2026a, 2026b): both are listed above as submitted; the volume/article numbers and DOIs resolve on acceptance. Two further references were considered and intentionally omitted: Givnish et al. (2014) on Bromeliaceae diversification (no supporting sentence is currently in the body) and a Fleischmann monograph on Utricularia sect. Orchidioides (the genus authority used here is Taylor 1989; the Fleischmann 2012 work is on Genlisea and is not the appropriate Utricularia authority). Add either only if a sentence requiring it is introduced.*
